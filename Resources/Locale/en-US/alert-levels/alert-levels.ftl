# NewHome: Do not say station, say local area/sector.
alert-level-announcement = Attention everyone! The alert level for your local area is now {$name}! {$announcement}
...
alert-level-blue-instructions = Crews are advised to be vigilant and report suspicious activity to local law enforcement
...
alert-level-orange-announcement = We have now entered a blackout period. Please take shelter and limit traveling at this time.
alert-level-orange-instructions = Stay inside, stay stationary.