...
nf-tips-dataset-27 = As an SLE officer, communicate and coordinate with your fellow officers using the SLE radio channel to avoid confusion.
nf-tips-dataset-28 = As an SLE officer, remember that correlation does not equal causation. Someone may have just been at the wrong place at the wrong time!
...
nf-tips-dataset-55 = When dealing with SLE, you may get your sentence reduced through cooperation and/or deception.
...
nf-tips-dataset-64 = NewHome is open source! If there's a change you want to make, or a simple item you want to add, then try contributing to the game. It's not as hard as you'd think it is.
...
nf-tips-dataset-106 = SLE has access to long range radar! If you're an outlaw, watch out for Prowlers stalking in the void!
...
nf-tips-dataset-111 = Remember, every local Outpost is a 150m wide safe-zone enforced by local law agencys. Damage property or do anything illegal and you may have law after you.
nf-tips-dataset-112 = If you're using an IFF console, remember that you are not completely hidden. If anyone gets too close your IFF will be revealed!
...
nf-tips-dataset-114 = Expeditions can yield rare and useful items, and not all of them are legal. Try not to leave those lying on the floor, as SLE might board you at some point!
...
nf-tips-dataset-116 = Every shuttle console has an internal traffic intercom. Make sure to use it to contact the STC before docking with the local outposts!
...
nf-tips-dataset-120 = There are multiple ways to earn money. Why not get a job on a local Outpost, join a law agency, go salvaging, do science, or do something totally illegal? Other players can teach you each one of them!
