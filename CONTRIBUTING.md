...
Modified contributing from [Aurora Song](https://github.com/AuroraSong14/Aurora-Song-14?tab=contributing-ov-file#](https://github.com/AuroraSong14/Aurora-Song-14?tab=contributing-ov-file))
...
"Upstream" refers to the [Aurora Song](https://github.com/AuroraSong14/Aurora-Song-14?tab=contributing-ov-file#](https://github.com/AuroraSong14/Aurora-Song-14?tab=contributing-ov-file)) repository that this fork was created from.
...
```cs
using Content.Client._NewHome.Emp.Overlays; // NewHome
```
...
NewHome uses specific prototypes for points of interest and ship maps (e.g. to store spawn information, station spawn data, or ship price and categories).  For ships, these are stored in the VesselPrototype (Resources/Prototypes/_NewHome/Shipyard) or PointOfInterestPrototype (Resources/Prototypes/_NewHome/PointsOfInterest).  If creating a new ship or POI, refer to existing prototypes, and submit new creations to Resources/Prototypes/_NewHome/Shipyard and Resources/Prototypes/_NewHome/PointsOfInterest respectively.
