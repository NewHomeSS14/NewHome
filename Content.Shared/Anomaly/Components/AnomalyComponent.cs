...
public sealed partial class AnomalyComponent : Component
{
    ...
    /// </summary>
    [DataField]
    public int MinPointsPerSecond = 10; // Frontier: 10<5, Aurora rever
    ...
    /// <summary>
    /// The number of points required to generate an output crystal
    /// </summary>
    [DataField]
    public int PointsPerCrystalUnit =  10000; // Aurora 5000>10000

    /// <summary>
    /// The maximum number of crystals generated by this anomaly.
    /// </summary>
    [DataField]
    public int MaxCrystals = 10; // Aurora, 3>10
